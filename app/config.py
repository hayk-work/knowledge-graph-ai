...
TAVILY_MAX_QUERY_LENGTH = int(os.getenv("TAVILY_MAX_QUERY_LENGTH", "400"))
SEARCH_QUERY_MAX_LENGTH = int(os.getenv("SEARCH_QUERY_MAX_LENGTH", "400"))
...
CHAT_SUMMARY_THRESHOLD = int(os.getenv("CHAT_SUMMARY_THRESHOLD", "10"))
